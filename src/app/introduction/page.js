      ...
      <div className="relative z-10 flex flex-col gap-10 max-w-5xl w-full px-6 text-sm text-neutral-200">
        {[
          ...
          },
          {
            ...
            color: "bg-[#fd92b8]",
            text: "２０２２年１２月４日にプロジェクト始動したMinecraft サーバー『らーす鯖』を運営している。開発チームのマネージャー兼モデレーターとして、サーバーの運営全般、特にコミュニティの秩序維持、プレイヤーサポート(お問い合わせ対応)、イベント企画・進行、SNS運用、プラグイン開発を行っている！",
          },
          {
            title: "Architecture / CAD",
            color: "bg-[#4CAF50]",
            text: "大学で Vectorworks や Archicad を用いて、建築設計・図面作成・3Dモデリングを行った経験がある。大学の授業では、プランのゾーニング、ラフスケッチ、各種意匠図の書き方、模型(スタディ模型)の作り方を学んでいる！今は保育施設の設計課題に取組中！！",
          },
        ].map((section, index) => (
          <div
            key={index}
